...
{% assign domcontentloaded = ".addEventListener('DOMContentLoaded'" %}
{% assign startasyncloading = ".addEventListener('StartAsyncLoading'" %}
...
activityEvents.forEach(function(t){
  window.addEventListener(t,loadJSscriptsNow,{once:!0})
});

document.addEventListener("DOMContentLoaded",loadJSscripts);
window.addEventListener("load",loadJSscripts);
window.attachEvent?window.attachEvent("onload",loadJSscripts):window.onload=loadJSscripts;
</script>
